...
/**
 * Editorial game catalogue for Aether.
...
export const games: Game[] = [
  ...
  },
  {
    ...
    description: {
      en: "Mahjong Ways 2 translates familiar tile aesthetics into a cascade-friendly slot grid. Instead of treating symbols as anonymous icons, the game leans on mahjong readability so pattern recognition feels natural. Aether’s coverage explains how cascades chain, how wilds assist incomplete lines of sight, and how free games alter the density of helpful tiles. We skip invented volatility scores. The pleasure of the title is visual literacy: learning which tiles matter when the board is noisy. Mobile players should enable stable brightness—tile edges matter—and avoid rushing past the rules overlay on first load. Cross-link our dedicated guide for board-reading drills and session pacing advice that stays free of fake math claims. Compared with Sweet Bonanza’s candy bombs, this dialect uses tile grammar; both teach cascade attention without requiring identical fantasies.",
      zh: "Mahjong Ways 2 把熟悉的牌面美学转成适合连消的老虎机网格。符号不是匿名图标，而是借麻将可读性让辨识更自然。Aether 说明连消如何接续、百搭如何补足视线，以及免费游戏如何改变有用牌的密度。我们跳过虚构波动分数。乐趣在于视觉识读：盘面嘈杂时分清哪些牌重要。手机玩家宜保持稳定亮度——牌边很重要——并避免首次加载时急着关掉规则层。可交叉阅读专属攻略，做读盘练习与会话节奏建议，且不涉及虚假数学宣称。相较 Sweet Bonanza 的糖果炸弹，这种方言用的是牌面语法；两者都教授连消注意力，却不必共享同一套幻想。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Lucky Neko keeps the tone light: beckoning-cat imagery, soft color accents, and features that arrive with playful motion rather than aggressive screen shake. Aether describes symbol roles, how free spins are framed in the UI, and why the title suits shorter evening sessions. No RTP invention, no lucky-hour myths—only structure and feel. If you like PG Soft’s portrait craft but want a gentler mood than adventure-heavy titles, Neko is a natural stop. Read the paytable once; the rest is watching how wilds and scatters are telegraphed. Use it as a calm contrast night against Wild Bandito’s sharper outlaw energy within the same studio family.",
      zh: "Lucky Neko 气质轻松：招财猫意象、柔和强调色，特色以俏皮动效登场而非激烈震屏。Aether 说明符号角色、免费旋转在界面中的呈现，以及为何适合较短的晚间会话。不编造返还率，也没有幸运时段神话——只有结构与手感。若喜欢 PG Soft 竖屏工艺、又想要比冒险向作品更柔的情绪，Neko 是自然一站。赔付表读一次即可，其余是观察百搭与散布如何被提示。可在同一工作室家族内，把它当作对照 Wild Bandito 更锐亡命徒能量的冷静之夜。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Wild Bandito trades soft festivity for dust, masks, and sharper contrast. Mechanically it still sits in PG Soft’s touch-friendly family, but the fantasy framing is more adventurous. Aether notes how wilds drive highlight moments and how the free-spin chapter changes anticipation. We keep claims grounded: what you see on the reels, not invented progressive meters. Useful for players comparing theme intensity inside one studio’s catalogue. Keep brightness honest outdoors—high contrast art can still wash out—and review wild transformation notes before turbo play so animations do not outrun comprehension.",
      zh: "Wild Bandito 用沙尘、面具与更锐对比取代柔和节庆感。机制仍属 PG Soft 触控友好家族，幻想包装更偏冒险。Aether 记录百搭如何驱动高光，以及免费旋转篇章如何改变期待。主张保持落地：你在转轮上看到的，而非虚构累计表。适合在同一工作室目录内比较主题强度的玩家。户外请保持真实亮度——高对比美术仍可能过曝——并在加速前复习百搭变形说明，以免动画快过理解。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Treasures of Aztec wraps cascade-friendly play in stone, gold, and exploration motifs. Aether’s description centers on how cascades reveal new opportunities and how free games are staged as a distinct chapter. We do not invent temple jackpots or hidden RTP. The page helps you decide if you want adventure cosmetics on top of PG Soft’s familiar mobile ergonomics. Read symbol tiers before a long commute session; temple palettes can hide low-contrast garnish on older screens. Pair with Temple Tumble from Relax if you want a spatial-puzzle cousin outside this studio.",
      zh: "Treasures of Aztec 用石材、金色与探索意象包裹适合连消的玩法。Aether 聚焦连消如何带来新机会，以及免费游戏如何被呈现为独立篇章。不编造神庙奖池或隐藏返还率。本页帮你判断是否要在 PG Soft 熟悉的手机人机上叠加冒险外观。长通勤会话前先读符号层级；神庙配色可能在旧屏上藏住低对比点缀。若想要工作室之外的空间解谜近亲，可搭配 Relax 的 Temple Tumble。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Gates of Olympus is a showcase for Pragmatic’s cascade-and-multiplier vocabulary. Symbols tumble, wins clear, and multipliers may arrive as dramatic stamps rather than quiet math footnotes. Aether explains the loop in plain language: what a cascade is, how multipliers display, and how free spins change the frequency of spectacle—without inventing RTP or guaranteed god drops. The title teaches players to watch the whole grid, not a single payline. Pair with our Olympus guide for a structured tour of symbol roles and calm session habits when animations intensify. Once the grammar feels familiar, Starlight Princess becomes an easier costume change rather than a new language.",
      zh: "Gates of Olympus 展示 Pragmatic 的连消与倍率语汇。符号下落、中奖清除，倍率常以戏剧化印记出现，而非安静的数学脚注。Aether 用白话解释循环：什么是连消、倍率如何显示、免费旋转如何改变奇观频率——不编造返还率或保证神降。作品教会玩家看整盘，而非单条赔付线。可搭配奥林匹斯攻略，系统浏览符号角色，并在动画变激烈时保持冷静会话习惯。语法熟悉后，Starlight Princess 更像换装，而不是新语言。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Starlight Princess re-skins the cascade-multiplier fantasy with anime character direction and glowing accents. If you already understand Olympus-style tumbles, this title feels like a familiar language in a new costume. Aether highlights UI differences and free-spin framing rather than inventing separate math myths. Good for players who prefer character-led art over marble gods. Keep the same calm-eye habits: finish sequences before changing stake, and treat free spins as a dense paragraph rather than a sacred obligation to continue all night.",
      zh: "Starlight Princess 用动漫角色方向与发光强调色重绘连消倍率幻想。若已理解奥林匹斯式下落，这部像熟悉语言换了新戏服。Aether 强调界面差异与免费旋转包装，而非编造另一套数学神话。适合偏好角色美术而非大理石神像的玩家。保持同样的冷静注视习惯：序列结束再改注额，并把免费旋转当作密段落，而非必须通宵继续的神圣义务。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Big Bass Bonanza mixes reel play with a fishing fantasy—collectible moments and free-game drama around the angler character. Aether explains the fantasy framing and feature flow without inventing catch tables or RTP. Useful if you like theme continuity across a series and want to know what the free spins are actually doing on screen. Do not confuse this reel fantasy with Jili fishing rooms: one is spin-led collection theater; the other is aiming-led seascape play. Keep that distinction when planning a mixed evening.",
      zh: "Big Bass Bonanza 把转轮玩法与钓鱼幻想混合——收集时刻，以及围绕钓手角色的免费游戏戏剧。Aether 解释幻想包装与特色流程，不编造渔获表或返还率。若喜欢系列主题连续性，并想弄清免费旋转在屏上实际做什么，很有用。不要把这种转轮幻想与 Jili 捕鱼房混淆：一个是旋转主导的收集剧场；另一个是瞄准主导的海景玩法。规划混合夜晚时保持区分。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Crazy Time is Evolution’s flagship chaos-with-structure show: a main wheel, named bonus games, and a UI that can feel busy until you learn the strip layout. Aether teaches betting-window timing, what each bonus name generally implies about presentation, and how to avoid chasing every top slot. We do not invent player counts or payout schedules. Watch a few rounds without betting to learn camera language, then engage with a plan for session length. Side bets are optional color, not obligatory quests—pick at most one secondary interest per round while learning.",
      zh: "Crazy Time 是 Evolution 旗舰的「有结构的热闹」秀：主转轮、具名奖励游戏，以及学会顶栏布局前可能显得拥挤的界面。Aether 教授投注窗时机、各奖励名大致意味着怎样的呈现，以及如何避免追每一个顶部格子。不编造玩家数或出款时间表。先不下注看几局学镜头语言，再带着会话时长计划参与。边注是可选色彩，不是必做任务——学习阶段每局最多选一个次要兴趣。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Monopoly Live fuses a wheel round with digital board fantasy. Hosts, 3D tokens, and property-themed bonus paths create a longer emotional arc than a single roulette spin. Aether maps the flow: base result, when a board segment begins, and how UI panels describe possible routes—still without fake odds. Give yourself time; this is not a three-second crash loop. Charge your phone before long walks if you watch on mobile, and do not schedule a twelve-minute arc into a five-minute break.",
      zh: "Monopoly Live 把转轮回合与数字棋盘幻想结合。主持、3D 棋子与地产主题奖励路径，情绪弧比单次轮盘旋转更长。Aether 梳理流程：基础结果、棋盘段何时开始、界面如何描述可能路线——依然没有假赔率。给自己留时间；这不是三秒飞升循环。若用手机观看，长行走前先充电，也不要把十二分钟弧线排进五分钟休息。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Goal packages a sports fantasy into Spribe’s short-round philosophy. You pick a path of risk, take the shot metaphor, and see a clean result. Aether describes decision points and pacing versus Aviator’s continuous curve—still without fake sportsbook odds. Nice palate cleanser between longer slot or live sessions. Review difficulty steps in the rules so you are choosing challenge level intentionally rather than tapping defaults mid-fatigue.",
      zh: "Goal 把体育幻想装进 Spribe 的短回合哲学。你选择风险路径，完成射门隐喻，看到干净结果。Aether 说明决策点，以及相对 Aviator 连续曲线的节奏差异——依然没有假体育赔率。适合在较长老虎机或真人会话之间换换口味。在规则中复习难度阶梯，以便有意识选择挑战等级，而不是在疲劳中点默认。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Mines is a grid of hidden threats. You choose how many mines to face, flip tiles, and decide when the multiplier on safe reveals is enough. Aether stresses intentional mine counts and cash-out discipline—no invented probability tables. Great for players who like discrete decisions more than spinning reels. Configure mine count when calm; raising it after a near-miss is a common fatigue trap our mobile guide warns about.",
      zh: "Mines 是一张藏着威胁的网格。你选择面对多少雷、翻格，并决定安全翻开带来的倍率何时够了。Aether 强调有意识的埋雷数与兑现纪律——没有虚构概率表。适合喜欢离散决策多于转轮的玩家。在冷静时配置埋雷数；几乎错过后再提高是常见疲劳陷阱，我们的移动攻略对此有提醒。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Super Ace dresses slot play in playing-card swagger. Combos and free-game bursts keep the screen lively. Aether maps symbol tiers and feature entry without fake poker odds. Helpful if you like card aesthetics but still want a pure slot loop. After Super Ace, Endorphina’s Lucky Streak 3 offers another card-adjacent mood with a more illustration-led European identity—useful for theme shopping without math myths.",
      zh: "Super Ace 用扑克气场包装老虎机。连击与免费游戏爆发让屏幕保持活跃。Aether 梳理符号层级与特色入口，没有假扑克赔率。若喜欢卡牌美学又要纯转轮循环，很有帮助。在 Super Ace 之后，Endorphina 的 Lucky Streak 3 提供另一种近卡牌情绪，但更偏欧洲插画识别——适合在没有数学神话的情况下按主题选游。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Boxing King sells impact: gloves, ropes, and hit feedback you can hear. Meters and feature rounds create a bout-like rhythm. Aether sticks to structure and responsible pacing notes—no invented championship prizes. Lower volume on long sessions if the mix fatigues you; arcade punch should not become pressure to continue after your time box ends.",
      zh: "Boxing King 贩售冲击感：手套、绳圈与听得见的击中反馈。进度与特色回合形成比赛般节奏。Aether 只谈结构与负责任节奏——没有虚构冠军奖金。长会话若混音让你疲劳可降低音量；街机冲击不应变成时间盒结束后仍继续的压力。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Happy Fishing softens the arcade fishing formula with brighter seas and a friendlier onboarding curve. Aether covers aiming basics and special-shot timing for newcomers migrating from slots. No fabricated jackpot fish tables. Prefer Wi-Fi for video-heavy rooms when possible, and keep one entertainment wallet separate from daily-pay apps as our mobile guide recommends.",
      zh: "Happy Fishing 用更亮的海色与更友好的上手曲线软化街机捕鱼公式。Aether 为从老虎机转来的新人覆盖瞄准基础与特殊弹时机。没有虚构头奖鱼表。视频向房间尽可能用 Wi-Fi，并按移动攻略建议把娱乐钱包与日常支付应用分离。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Riot trades polite luck charms for amplifiers and grit. The mechanical core stays approachable; the soundtrack and art do the heavy lifting. Aether describes tone and feature brevity for players shopping by mood. Still no invented award lists. Lower volume if the mix is intense for long sessions—audio identity is a feature, not a command to overplay.",
      zh: "Riot 用音箱与粗粝感替换礼貌的好运护符。机制核心仍然好懂；配乐与美术承担重活。Aether 为按情绪选游的玩家描述基调与特色简洁度。依然没有虚构奖项清单。长会话若混音太猛可降低音量——音频识别是特色，不是多开的命令。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Money Train 2 is less spin-and-smile and more learn-the-map. Characters can perform actions that reshape feature rounds, and persistence across free spins creates story-like tension. Aether walks through what tends to persist versus reset, without inventing payout ladders. Read the guide-friendly paytable twice before turbo mode. Against Jili’s instant arcade hits, this title asks for map literacy and patience between character actions.",
      zh: "Money Train 2 少些「转了就笑」，多些「学会地图」。角色可执行改写特色回合的行动，免费旋转间的持续性制造故事般张力。Aether 梳理何为通常保留、何为重置，不编造派彩阶梯。开加速前把友好的赔付表读两遍。相对 Jili 的即时街机击中，这部要求地图识读与角色行动之间的耐心。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Temple Tumble asks you to think spatially: tumbles clear stone, paths open, and free games can emphasize that puzzle logic. Aether explains board reading for players coming from line-pay slots. No invented archaeology jackpots—just structure and feel. Pair with Treasures of Aztec if you want adventure cosmetics with a different studio’s cascade dialect in the same week.",
      zh: "Temple Tumble 要求空间思考：下落清除石块、道路打开，免费游戏可强化这种解谜逻辑。Aether 为从线赔老虎机转来的玩家解释读盘。没有虚构考古奖池——只有结构与手感。若同一周想要冒险外观但换一家工作室的连消方言，可搭配 Treasures of Aztec。"
    },
    howToPlay: {
  ...
  },
  {
    ...
    description: {
      en: "Buffalo Power keeps Playson’s clarity promise: strong animal icons, modes you can explain in a paragraph, and scaling that works from desktop to phone. Aether details mode transitions and symbol priority without RTP fiction. A dependable pick when you want theme punch without opaque systems. Adjust stake only between resolved rounds so mode changes do not collide with mid-spin edits.",
      zh: "Buffalo Power 兑现 Playson 的清晰承诺：强烈动物图标、一段话能说明的模式，以及桌面到手机都成立的缩放。Aether 详述模式切换与符号优先级，没有返还率虚构。想要主题冲击力又不想要不透明系统时，是可靠之选。仅在回合结算之间调整注额，以免模式切换与旋转中途编辑冲突。"
    },
    howToPlay: {
